 ...
 * @author hp
 */
public class CetakLaporanPemasukan extends javax.swing.JFrame {

    /**
     * Creates new form CetakLaporanPemasukan
     */
    public CetakLaporanPemasukan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LAPORAN PEMASUKAN BARANG");
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        try {
        JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("LaporanPemasukan.jasper"), null, Connectionz.GetConnection());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakLaporanPemasukan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CetakLaporanPemasukan().setVisible(true);
            }
        });
    }
